...
public class QuizDifficultyLevelService(IGenericRepository<QuizDifficulty> quizDifficultyRepository, IMapper mapper, IHttpContextAccessor httpContextAccessor, IDropDownDataService dropDownDataService) : IQuizDifficultyLevelService
{
    ...
    public async Task<string> CreateDifficultyLevel(QuizDifficultyRequestDto difficultyRequestDto)
    {
        ...
        dropDownDataService.ClearCache(DropDownType.QuizDifficulty);
