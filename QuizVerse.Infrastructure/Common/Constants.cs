...
public static class Constants
{
    ...
    public const string QUIZ_CATEGORY_STATUS_ALREADY_SET = "Category is already {0}.";
    public const string QUIZ_CATEGORY_STATUS_CHANGED_SUCCESS = "Category status changed to {0}.";
    #endregion
